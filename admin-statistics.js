(function () {
  ...
  function render() {
    ...
    document.getElementById('statisticsPeople').innerHTML = '<div class="statisticsPeopleTitle"><span>Посещения по име</span><div class="statisticsSort" aria-label="Сортирай статистиката"><span>Сортирай</span><button type="button" class="' + (sortMode === 'name' ? 'active' : '') + '" onclick="selectStatisticsSort(\'name\')">По име</button><button type="button" class="' + (sortMode === 'visits' ? 'active' : '') + '" onclick="selectStatisticsSort(\'visits\')">По посещения</button></div></div>' + (people.length
